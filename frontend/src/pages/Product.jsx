...
import { formatCurrency, formatRelativeTime, calculateTrends } from '../utils/frontend-helpers';
...
const Product = () => {
    ...
    const averagePrice =
    product.graph_data.reduce((sum, item) => sum + Number(item.min_price), 0) / product.graph_data.length;
    
    // Intelligence Data
    const { buySignal, predictedDrop, nextExpectedDeal } = product.intelligence || {};
        const productURL = `https://amzn.in/d/"${product.pid}`;
          ...
          <div className="product-info">
            ...
            <div className="intelligence-strip">
              ...
              <div className="intel-item">
                ...
                <span className="intel-value">{formatCurrency(averagePrice)}</span>
              </div>
              <div className="intel-item">
